...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SAVEDFORMS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SAVEDFORMS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SAVEDFORMS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SAVEDFORMS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SAVEDFORMS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SAVEDFORMS actions', async () => {
      const arg = 42666;
