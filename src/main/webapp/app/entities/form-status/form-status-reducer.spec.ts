...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FORMSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FORMSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FORMSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FORMSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FORMSTATUS actions', async () => {
      const arg = 42666;
