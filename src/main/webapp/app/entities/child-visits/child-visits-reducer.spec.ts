...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDVISITS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDVISITS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDVISITS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDVISITS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDVISITS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDVISITS actions', async () => {
      const arg = 42666;
