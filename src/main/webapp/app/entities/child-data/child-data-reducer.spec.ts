...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDDATA actions', async () => {
      const arg = 42666;
