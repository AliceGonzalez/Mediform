...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATEFORM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TEMPLATEFORM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TEMPLATEFORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TEMPLATEFORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATEFORM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TEMPLATEFORM actions', async () => {
      const arg = 42666;
