...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './login.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOGIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOGIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOGIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOGIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOGIN actions', async () => {
      const arg = 42666;
