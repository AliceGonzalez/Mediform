          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('childID')}>
                  Child ID <FontAwesomeIcon icon={getSortIconByFieldName('childID')} />
                </th>
            ...
            <tbody>
              {childList.map((child, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{child.dob ? <TextFormat type="date" value={child.dob} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
